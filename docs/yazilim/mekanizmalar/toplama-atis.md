...
// Donanım
static probot::motor::BoardozaVNHMotorDriver intakeMotor(
...
// Donanım (çift motor)
static probot::motor::BoardozaVNHMotorDriver intakeLeftHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
static probot::motor::BoardozaVNHMotorDriver intakeRightHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
...
#### RPM kontrollü (ClosedLoopMotor ile)
Encoder destekli yapıda hedef hız (RPM) veririz; `ClosedLoopMotor` hız geri bildirimiyle komutu tutarlı kılar. Bu, objenin “takıla‑kalma” ve hız dalgalanması olmadan içeri alınmasını kolaylaştırır.
```cpp
// Hedef hız (RPM)
...
static probot::sensors::IEncoder& intakeEnc = /* DOLDUR: encoder nesneniz */;
static probot::control::PidConfig g_intakeVelPidCfg{
  /* kp */, /* ki */, /* kd */, /* kf */ 0.0f, -1.0f, 1.0f
};
static probot::control::PID g_intakeVelPid(g_intakeVelPidCfg);
static probot::control::ClosedLoopMotor g_intakeLoop(
  &intakeEnc,
  &g_intakeVelPid,
  &intakeMotor,
  kTicksPerSecToRpm, // hız dönüşümü (ticks/s → RPM)
  kRevPerTick        // pozisyon dönüşümü (ticks → tam tur)
);

void setIntakeRPM(float rpm){
  g_intakeLoop.setSetpoint(rpm, probot::control::ControlType::kVelocity);
}

float getIntakeRPM(){
  return g_intakeLoop.lastMeasurement();
}
```
...
// Donanım
static probot::motor::BoardozaVNHMotorDriver shooterMotor(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
...
static probot::motor::BoardozaVNHMotorDriver shooterLeftHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
static probot::motor::BoardozaVNHMotorDriver shooterRightHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
...
static probot::motor::BoardozaVNHMotorDriver shooterLeftSameHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
static probot::motor::BoardozaVNHMotorDriver shooterRightSameHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
...
// Donanım (encoder + VNH sürücüler)
static probot::motor::BoardozaVNHMotorDriver shooterLeftVelHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
static probot::motor::BoardozaVNHMotorDriver shooterRightVelHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
static probot::sensors::IEncoder& shooterLeftEnc  = /* DOLDUR: sol encoder */;
static probot::sensors::IEncoder& shooterRightEnc = /* DOLDUR: sağ encoder */;
...
static probot::control::PID g_shooterLeftPid (g_shooterVelPidCfg);
static probot::control::PID g_shooterRightPid(g_shooterVelPidCfg);

static probot::control::ClosedLoopMotor g_shooterLeftLoop(
  &shooterLeftEnc,
  &g_shooterLeftPid,
  &shooterLeftVelHW,
  kShooterTicksPerSecToRpm,
  kShooterRevPerTick
);
static probot::control::ClosedLoopMotor g_shooterRightLoop(
  &shooterRightEnc,
  &g_shooterRightPid,
  &shooterRightVelHW,
  kShooterTicksPerSecToRpm,
...
void setShooterRPM(float rpm){
  g_shooterLeftLoop.setSetpoint(+rpm, probot::control::ControlType::kVelocity);
  g_shooterRightLoop.setSetpoint(-rpm, probot::control::ControlType::kVelocity); // ters yönde dönen teker
}
...
// Donanım
static probot::motor::BoardozaVNHMotorDriver conveyor(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
...
static probot::sensors::IEncoder& convEnc = /* DOLDUR: encoder nesneniz */;
static probot::control::PidConfig g_convVelPidCfg{
  /* kp */, /* ki */, /* kd */, /* kf */ 0.0f, -1.0f, 1.0f
};
static probot::control::PID g_convVelPid(g_convVelPidCfg);
static probot::control::ClosedLoopMotor g_convLoop(
  &convEnc,
  &g_convVelPid,
  &conveyor,
  kConvTicksPerSecToRpm,
  kConvRevPerTick
);

void setConveyorRPM(float rpm){
  g_convLoop.setSetpoint(rpm, probot::control::ControlType::kVelocity);
}

float getConveyorRPM(){
  return g_convLoop.lastMeasurement();
}
```
...
static probot::motor::BoardozaVNHMotorDriver convFrontHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
static probot::motor::BoardozaVNHMotorDriver convRearHW(
  /* INA */, /* INB */, /* PWM */, /* ENA veya -1 */, /* ENB veya -1 */);
...
<div class="progress">
  <div class="progress__track">
    <div class="progress__bar" style="width: 72%; background: linear-gradient(90deg, #57b135, #57b135)"></div>
  </div>
